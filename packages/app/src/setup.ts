...
export async function runSetup(_nonInteractive = false): Promise<void> {
  ...
  console.error('Recommended mode: lightweight');
...
export async function runDoctor(): Promise<void> {
  ...
  if (!facts.hasBrainDir) {
    ...
    console.error('- Your repository is ready for lightweight Project Brain usage.');
  }
}
...
export async function runInit(): Promise<void> {
  ...
  await ensureBrainInitialized(facts);
  console.error('- Next: run `project-brain setup` for usage guidance.');
}
...
export function printHelp(): void {
  ...
  console.error('');
  console.error('Usage:');
  console.error('  project-brain setup           Initialize .project-brain/ and print lightweight usage guidance');
  console.error('  project-brain doctor          Check repository readiness for lightweight usage');
